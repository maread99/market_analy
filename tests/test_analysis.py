...
class TestAnalysis:
    ...
    def test_trends_chart(self, analy, trend_kwargs, trend_period_kwargs):
        ...
        verify_app(f, TrendsGui, interval, trend_kwargs, **kwargs)
        ...
        def assert_trend_reflects_move(move: Movement):
        ...
        # verify break_rule
        def verify_break_rule(rule: bqu.TrendRule, move: Movement):
        ...
        # verify limit_rule
        def verify_limit_rule(rule: bqu.TrendRule, move: Movement):
            for c in rule.components:
                assert c.visible
                assert c in gui.chart.figure.marks
            assert len(rule.line.x) == prd
